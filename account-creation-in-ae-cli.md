                                 ...
                                 +    Creating an æternity Account With CLI     +
...
This tutorial will walk you through the process of creating an account (wallet) through the **AECLI** tool.
We will install **aepp-cli-js**(javascript version of CLI), create an account and will go through the basic account commands.
===============
 Prerequisites
===============
        $ sudo apt update
...
- Install NodeJs and Npm (node package manager)
        ...
        $ node -v
- If already installed, make sure NodeJs and Npm are up to date, use the following commands 
        $ node -v
        $ sudo npm install -g n
        $ sudo -n stable
- Replace version number with the installed, at this moment it's ***12.13.0***
        $ sudo ln -sf /usr/local/n/versions/node/12.13.0/bin/node /usr/bin/node   
        $ node -v
        $ sudo apt reinstall npm
        $ sudo reboot
==========================
